...
class PoissonHyperParamStats : public HyperParamStats {
 public:
  PoissonHyperParamStats();
...
class Poisson : public HPFCouplingInterface{
 public:
  Poisson();
  Poisson(double lambda_, int n_trunc_, int val_max_, double xi_, double tau_);
  void initialize(double lambda_, int n_trunc_, int val_max_, double xi_, double tau_);
  ...
  void update_hyperparam(PoissonHyperParamStats* stats);
  ...
  void update(int val, PoissonHyperParamStats* stats);
  ...
  void update_q_n(unsigned long int ui, unsigned long int ii, double log_lambda,
                  ...
                  vector<double>& q_n);
  void update(int val, PoissonHyperParamStats* stats, double e_phi);
  void update(unsigned long int ui, unsigned long int ii, double val,
              vector<double>& buffer_k, vector<double>& buffer_n,
