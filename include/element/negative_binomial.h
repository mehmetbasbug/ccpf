...
class NegativeBinomialHyperParamStats : public HyperParamStats {
 public:
  NegativeBinomialHyperParamStats();
  void initialize(double p_0);
  void update_p_alpha(double sum_x);
  void update_p_beta(double sum_r);
...
class NegativeBinomial : public HPFCouplingInterface {
 public:
  NegativeBinomial();
  NegativeBinomial(double p_, double r_, int n_trunc_, int val_max_, double xi_,
                   double tau_);
  void initialize(double p_, double r_, int n_trunc_, int val_max_, double xi_,
                  double tau_);
  ...
  void update_hyperparam(NegativeBinomialHyperParamStats* stats);
  ...
  void update(int val, NegativeBinomialHyperParamStats* stats);
  ...
  void update_q_n(unsigned long int ui, unsigned long int ii, double log_lambda,
                  ...
                  vector<double>& q_n);
  void update(int val, NegativeBinomialHyperParamStats* stats, double e_phi);
  void update(unsigned long int ui, unsigned long int ii, double val,
              vector<double>& buffer_k, vector<double>& buffer_n,
